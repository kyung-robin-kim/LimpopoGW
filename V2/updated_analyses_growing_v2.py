...
######################################################################################################################################################
#GROUNDWATER INSITU
SA_gw_data = pd.read_csv(glob.glob(r'B:\Limpopo_VegetationHydrology\Data\sophia\Limpopo In-Situ Data\Boreholes\*.csv')[-2])
...
#SA_gw_data_LULC = pd.read_csv(glob.glob(r'B:\Limpopo_VegetationHydrology\Data\sophia\Limpopo In-Situ Data\Boreholes\lulc_boreholes\*.csv')[0]).iloc[:,[1,-1,-2]]
...
plt.xlim(pd.to_datetime('2003-02-01'),pd.to_datetime('2022-07-01'))
plt.tight_layout()
plt.savefig(r'C:\Users\robin\Desktop\Limpopo_VegetationHydrology\DraftFigures\V2\GrowingSeason_v3.png',dpi=300)
...
fig = plt.figure(figsize=(8,4))
ax = fig.add_subplot()
ax.plot(spatial_mean_anomalies_vars_monthly[2].time,spatial_mean_anomalies_vars_monthly[2],color='black',linewidth=2,label='CLSM GW')
...
ax2 = ax.twinx()
ax2.plot(spatial_mean_anomalies_vars_monthly[4].time,spatial_mean_anomalies_vars_monthly[4],color='C2',linewidth=2,label='MODIS NDVI')
...
plt.tight_layout()
plt.savefig(r'C:\Users\robin\Desktop\Limpopo_VegetationHydrology\DraftFigures\V2\MonthlyAnomalies_v3.png',dpi=300)
